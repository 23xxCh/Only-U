...
1. Critical-event section coverage weakened.
2. TUI confirmation gate no longer tested.
3. Sequential stdout/stderr read deadlock risk.
4. Scan test did not prove user-visible skip explanation.
5. Startup fallback coverage removed.
6. Child process exit code not checked.

```diff
3e16c62 test: harden diagnose encoding coverage
 portable/tests/diagnose.Tests.ps1 | 58 +++++++++++++++++++++++++++++----------
 1 file changed, 44 insertions(+), 14 deletions(-)
diff --git a/portable/tests/diagnose.Tests.ps1 b/portable/tests/diagnose.Tests.ps1
index 4b7e21e..782dcad 100644
...
@@ -34,52 +51,62 @@ Describe 'Only-U offline diagnose' {
         $previousTmp = $env:TMP
...
@@ -89,17 +116,20 @@ Describe 'Only-U offline diagnose' {
